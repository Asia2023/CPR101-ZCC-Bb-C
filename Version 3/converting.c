...
void converting(void)
{
	...
	do
	{
		...
		fgets(longString, BUFFER_SIZE, stdin); // Read input of the BUFFER_SIZE and sends to the terminal
	...
	} while (strcmp(longString, "q") != 0); // Execute the loop untill q is entered for quit
